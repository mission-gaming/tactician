...
See docs/ROADMAP.md:
- **Phase 3** (milestones 1-3 of 5 done — see the design doc): progression selectors/pools/bracket presets/two-legged ties + elimination engines conforming to the stage interface (M4), sweep (M5)
